// Keep this file identical to supabase/functions/_shared/schema.ts: the browser (demo mode) and the
// Edge Functions (full platform) must ask the AI for exactly the same shape.
